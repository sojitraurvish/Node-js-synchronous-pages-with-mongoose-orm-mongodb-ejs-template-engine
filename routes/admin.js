...
routes.post("/auth",
    ...
    check("email","Please enter a valid email!...")//if i don't pass from here so it will take by default message for error
        .isEmail()
...
// GET : /admin/category/manage_category -> to open manage_category page for insert
routes.get("/category/manage_category",auth.admin_auth,auth.getCsrfToken,categoryControllers.open_manage_category_process);

// GET : /admin/category/manage_category -> to open manage_category page for update
...
// POST : /admin/category/manage_category -> to insert and update data
